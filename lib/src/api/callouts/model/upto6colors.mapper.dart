...
class UpTo6ColorsMapper extends ClassMapperBase<UpTo6Colors> {
  ...
  static const Field<UpTo6Colors, int> _f$color1Value = Field(
    'color1Value',
    _$color1Value,
    opt: true,
  );
  static int? _$color2Value(UpTo6Colors v) => v.color2Value;
  static const Field<UpTo6Colors, int> _f$color2Value = Field(
    'color2Value',
    _$color2Value,
    opt: true,
  );
  static int? _$color3Value(UpTo6Colors v) => v.color3Value;
  static const Field<UpTo6Colors, int> _f$color3Value = Field(
    'color3Value',
    _$color3Value,
    opt: true,
  );
  static int? _$color4Value(UpTo6Colors v) => v.color4Value;
  static const Field<UpTo6Colors, int> _f$color4Value = Field(
    'color4Value',
    _$color4Value,
    opt: true,
  );
  static int? _$color5Value(UpTo6Colors v) => v.color5Value;
  static const Field<UpTo6Colors, int> _f$color5Value = Field(
    'color5Value',
    _$color5Value,
    opt: true,
  );
  static int? _$color6Value(UpTo6Colors v) => v.color6Value;
  static const Field<UpTo6Colors, int> _f$color6Value = Field(
    'color6Value',
    _$color6Value,
    opt: true,
  );
