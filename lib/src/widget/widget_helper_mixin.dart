...
// }
  ...
  Widget boxChild({required Widget child, Color? bgColor}) =>
      Material(
        elevation: 20,
        child: Container(
...
//}
  ...
  Text text16(String s,
      {Color theBgColor = Colors.white, Color color = Colors.black}) =>
      Text(
        s,
        style: TextStyle(
            fontSize: 16, color: color, background: bgPaint(theBgColor)),
      );

  Text text18(String s, {Color theBgColor = Colors.white, key}) =>
      Text(
        s,
        key: key,
...
//     );
  ...
  Widget assetPicWithFadeIn({required String path,
    Alignment alignment = Alignment.center,
    double? width,
    double? height,
    EdgeInsets padding = const EdgeInsets.all(20.0),
...
// }
  ...
  double calculateAutoscaleFontSize(String text, TextStyle style,
      double startFontSize, double maxWidth) {
  ...
  Paint linePaint(Color theColor, {double theThickness = 1.5}) =>
      Paint()
        ..color = theColor
  ...
  Paint thickLinePaint(Color theColor) =>
      Paint()
        ..color = theColor
        ..strokeCap = StrokeCap.round
        ..style = PaintingStyle.stroke
...
// ignore: non_constant_identifier_names
  ...
  ButtonStyle blackOnGrey() =>
      ElevatedButton.styleFrom(
        backgroundColor: Colors.grey[200], // background
        foregroundColor: Colors.black, // foreground
      );

  ButtonStyle redOnGrey() =>
      ElevatedButton.styleFrom(
        backgroundColor: Colors.grey[200], // background
...
// }
  ...
  Widget boxedText({String text = '', Color? color}) =>
      Container(
